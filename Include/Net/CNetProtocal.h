...
namespace irr {
    namespace net {
        ...
        public:
            ...
            CQueueRing* createSegment(s32 size);

            void log(s32 mask, const s8 *fmt, ...);
            void updateACK(s32 rtt);
            void shrinkBuffer();
            void parseSegment(CQueueRing* newnode);
        ...
        private:
            ...
            u32 mTimeCurrent;                                                      ///<Current time
            u32 mTimeFlush;                                                           ///<flush time
            u32 mXMIT;
            ...
            u32 mSendQueueCount;
            CQueueRing mQueueSend;
            CQueueRing mQueueReceive;
            CQueueRing mQueueSendBuffer;
            CQueueRing mQueueReceiveBuffer;

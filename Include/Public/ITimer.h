...
namespace irr {
    ...
    public:
        ...
        static const ITimer::SDate& getDate();
        ...
        static const c8* getTimeAsString(const ITimer::SDate& date, u32 type = ETST_YMD);

        static s32 addYearMonthDay(const ITimer::SDate& date, u32 max, c8* cache);

        static s32 addHourMinSecond(const ITimer::SDate& date, u32 max, c8* cache);
    };

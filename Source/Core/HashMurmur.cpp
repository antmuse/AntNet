...
static APP_FORCE_INLINE u32 AppRotate32(u32 x, s32 r) {
    return (x << r) | (x >> (32 - r));
}

static APP_FORCE_INLINE u64 AppRotate64(u64 x, s32 r) {
    return (x << r) | (x >> (64 - r));
}

// Finalization mix - force all bits of a hash block to avalanche
static APP_FORCE_INLINE u32 AppAvalanche32(u32 h) {
    h ^= h >> 16;
    h *= 0x85ebca6bU;
    h ^= h >> 13;
    h *= 0xc2b2ae35U;
...
// Finalization mix - force all bits of a hash block to avalanche
static APP_FORCE_INLINE u64 AppAvalanche64(u64 k) {
    k ^= k >> 33;
